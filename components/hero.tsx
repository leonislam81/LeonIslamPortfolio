...
import { ArrowDownRight, ArrowRight, CalendarCheck2, CalendarDays, CheckCircle2, Clock3, Code2, Gauge, Globe2, MessageCircle, Sparkles, Zap } from "lucide-react"
...
export function Hero() {
  ...
  const trackWhatsAppClick = () => trackEvent("hero_whatsapp_click", { event_category: "engagement", contact_method: "whatsapp" })
