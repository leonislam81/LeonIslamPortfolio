...
type Campaign = { id: string; subject: string; message: string; recipient_count: number; status: "Draft" | "Sent" | "Failed"; error_message: string | null; sent_at: string | null; open_count: number; click_count: number; created_at: string }
