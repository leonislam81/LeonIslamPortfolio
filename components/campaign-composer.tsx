...
type Campaign = { id: string; subject: string; message: string; recipient_count: number; status: "Draft" | "Sent" | "Failed"; error_message: string | null; sent_at: string | null; created_at: string }
