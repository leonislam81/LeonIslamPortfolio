...
export function DashboardContentEditor({ initialPages, userId }: { initialPages: Page[]; userId: string }) {
  ...
  const publishPage = () => {
    if (!draft || !window.confirm(`Publish “${draft.title}” to the live site now?`)) return
    void save("Published")
  }
