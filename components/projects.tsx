...
const projects = [
  {
    ...
    platform: 'Shopify',
    description:
      'Redesigned checkout flow for fashion retailer, reducing cart abandonment significantly.',
    ...
    problem:
      'High cart abandonment rate (78%) due to complex checkout process and trust issues.',
    approach:
      'Streamlined checkout to single page, added trust badges, optimized mobile experience.',
  ...
  },
  {
    ...
    platform: 'WordPress',
    description:
      'Complete performance optimization bringing site from poor to excellent Lighthouse scores.',
    ...
    problem:
      'Slow loading times (8+ seconds) causing high bounce rates and poor SEO rankings.',
    approach:
      'Image optimization, caching implementation, database cleanup, code minification.',
    result:
      'Load time reduced to 2.1s, Core Web Vitals all green, 40% bounce rate reduction.',
    testimonial: {
  ...
  },
  {
    ...
    platform: 'Wix',
    description:
      'Complete mobile redesign for service business, focusing on user engagement and conversions.',
    ...
    approach:
      'Mobile-first redesign with simplified navigation and touch-optimized interactions.',
  ...
  },
  {
    ...
    platform: 'WordPress',
    description:
      'Migrated 5,000+ products and posts with custom fields, maintaining SEO and structure.',
    ...
    problem:
      'Complex migration from legacy system with custom data structures and relationships.',
    approach:
      'Custom migration scripts with data validation, staging environment testing, zero-downtime deployment.',
    result:
      '100% data integrity maintained, all SEO rankings preserved, seamless transition.',
    testimonial: {
  ...
  },
  {
    ...
    description:
      'Resolved 15+ critical bugs across WordPress, Shopify, and custom solutions in 48 hours.',
    ...
    problem:
      'Multiple critical issues causing site crashes, payment failures, and user experience problems.',
    approach:
      'Systematic debugging, priority triage, cross-browser testing, and comprehensive QA.',
    result:
      'All critical issues resolved, site stability restored, preventive measures implemented.',
    testimonial: {
  ...
  },
  {
    ...
    platform: 'WordPress',
    description:
      'Monthly maintenance and updates for growing SaaS company, ensuring security and performance.',
    impact: '99.9% Uptime',
    ...
    problem:
      'Need for reliable ongoing maintenance without internal technical resources.',
    approach:
      'Proactive monitoring, regular updates, security hardening, performance optimization.',
    result:
      'Zero security incidents, consistent performance, rapid issue resolution.',
    testimonial: {
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="modal-section grid grid-cols-1 md:grid-cols-3 gap-4">
                {Object.entries(selectedProject.metrics).map(([key, value]) => (
                  ...
                  >
                    <div className="text-2xl font-bold text-portfolio-primary mb-1">
                      {value}
                    </div>
