...
const navigation = [
  ...
  { label: "Audit & leads", href: "/dashboard#pipeline", icon: ClipboardList },
  { label: "Follow-up calendar", href: "/dashboard#calendar", icon: CalendarDays },
