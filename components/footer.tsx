...
export function Footer() {
  ...
  return <footer className="overflow-hidden border-t border-border bg-slate-50 text-foreground dark:bg-slate-950">
    <div className="container mx-auto px-4 pt-16 sm:pt-20">
      ...
      <div className="flex flex-col gap-3 border-t border-border py-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between"><span>Copyright {currentYear} Leon Islam. Built with care.</span><span>Clear communication | Reliable delivery | Practical results</span></div>
