...
const principles = [
  { icon: MessageCircleMore, title: "No confusing hand-offs", text: "You always know what is being worked on, what information is needed, and what comes next." },
  { icon: TimerReset, title: "Momentum without the noise", text: "Focused priorities and dependable replies keep your website, catalog, and admin tasks moving." },
  { icon: ShieldCheck, title: "Accurate work that stays organized", text: "Updates, product data, research, and ongoing improvements have one consistent home when you need them." },
]
