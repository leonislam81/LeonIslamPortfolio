...
export default async function DashboardPage() {
  ...
  const { data, error } = await supabase.from("audit_leads").select("id, website_url, email, status, performance, seo, business_goal, created_at, follow_up_at, re_audit_at").order("created_at", { ascending: false }).limit(250)
